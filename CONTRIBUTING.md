...
* Search the [Existing Issues](https://github.com/PaystackHQ/sample-paystack-pop/issues) to be sure that the one you've noticed isn't already there
...
* Make the changes to your forked repository's branch. 
